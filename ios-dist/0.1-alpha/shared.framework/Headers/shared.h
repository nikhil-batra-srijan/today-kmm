...
- (instancetype)initWithUuid:(NSString *)uuid viewMode:(NSString *)viewMode labelDisplay:(BOOL)labelDisplay __attribute__((swift_name("init(uuid:viewMode:labelDisplay:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (SharedLazyLoadComponent *)doCopyUuid:(NSString *)uuid viewMode:(NSString *)viewMode labelDisplay:(BOOL)labelDisplay __attribute__((swift_name("doCopy(uuid:viewMode:labelDisplay:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((swift_name("InfiniteScrollData")))
@protocol SharedInfiniteScrollData
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InfiniteScrollComponentData")))
@interface SharedInfiniteScrollComponentData : SharedBase <SharedInfiniteScrollData>
- (instancetype)initWithUuid:(NSString *)uuid viewMode:(NSString *)viewMode nextPage:(int32_t)nextPage itemList:(NSArray<id<SharedComponentDetailStoryItem>> *)itemList __attribute__((swift_name("init(uuid:viewMode:nextPage:itemList:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (int32_t)component3 __attribute__((swift_name("component3()")));
- (NSArray<id<SharedComponentDetailStoryItem>> *)component4 __attribute__((swift_name("component4()")));
- (SharedInfiniteScrollComponentData *)doCopyUuid:(NSString *)uuid viewMode:(NSString *)viewMode nextPage:(int32_t)nextPage itemList:(NSArray<id<SharedComponentDetailStoryItem>> *)itemList __attribute__((swift_name("doCopy(uuid:viewMode:nextPage:itemList:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<id<SharedComponentDetailStoryItem>> *itemList __attribute__((swift_name("itemList")));
@property (readonly) int32_t nextPage __attribute__((swift_name("nextPage")));
@property (readonly) NSString *uuid __attribute__((swift_name("uuid")));
@property (readonly) NSString *viewMode __attribute__((swift_name("viewMode")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InfiniteScrollError")))
@interface SharedInfiniteScrollError : SharedBase <SharedInfiniteScrollData>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)infiniteScrollError __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedInfiniteScrollError *shared __attribute__((swift_name("shared")));
@end;
...
- (void)clearLandingPageStoryList __attribute__((swift_name("clearLandingPageStoryList()")));
- (SharedCFlow<id<SharedLandingPageComponent>> *)fetchComponentDetailLazyLoadComponent:(SharedLazyLoadComponent *)lazyLoadComponent __attribute__((swift_name("fetchComponentDetail(lazyLoadComponent:)")));
- (SharedCFlow<id<SharedInfiniteScrollData>> *)fetchInfiniteScrollComponentUuid:(NSString *)uuid viewMode:(NSString *)viewMode page:(int32_t)page __attribute__((swift_name("fetchInfiniteScrollComponent(uuid:viewMode:page:)")));
...
- (SharedLandingRepository *)doInitBaseUrl:(NSString *)baseUrl __attribute__((swift_name("doInit(baseUrl:)")));
@end;
