package com.mediacorp.newscorekmm.data.domain.dto.landing.component.dl_featured_image_middle_eight_stories_four_pics
...
data class FeaturedImageMiddleEightStoriesFivePicsComponent(
    val uuid: String,
    val title: TitleData,
    val ctaData: CtaData,
